...
const Contact = () => {
  return (
    <div id='contact' className='flex flex-col justify-between contact w-full h-screen bg-bluePrimary'>
          <h5 className='text-skyClear text-[1.5rem] md:text-[3rem] px-5'>Social Media</h5>
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-4 items-center' id='icon-container'>
            ...
            <div className="flex justify-center items-center">
              <Link href="https://www.youtube.com/@iducDev" target="_blank" rel="noreferrer" >
                <Image className="w-[100px] rounded-lg" src={youtube}  alt="img"/>
              </Link>
            </div>
            <div className="flex justify-center items-center ">
